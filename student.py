...
class Student:
    ...
    # This part is image labels setting start 
        ...
        dep_combo["values"]=("Select Department","Computer Science", "Electronics", "Mechanical", "Civil", "Electrical")
        dep_combo.current(0)
        ...
        cou_combo["values"]=("Select Course", "B.Tech", "M.Tech", "Ph.D", "BBA", "MBA")
        cou_combo.current(0)
        ...
        year_combo["values"]=["Select Year"] + [str(year) for year in range(2017, 2026)]
